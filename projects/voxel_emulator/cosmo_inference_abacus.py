...
def get_true_params(
    ...
    param_dict = dict(
        pd.read_csv(
            f"/pscratch/sd/t/tsfraser/new_sunbird/sunbird/data/parameters/abacus/voidprior/AbacusSummit_c{str(cosmology).zfill(3)}.csv"
        ).iloc[hod_idx]
    )
    if add_fsigma8:
...
args.add_argument('--chain_dir', type=str, default='/pscratch/sd/t/tsfraser/sunbird/chains/voxel_voids/')
...
chain_handles = [
    #'abacus_c0_voxel_voids_mae_patchycov_vol64_smin0.70_smax120.00_m02_base_NEW_RUN_4PARAM',

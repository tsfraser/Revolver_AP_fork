...
if __name__ == "__main__":
    output_path = Path("/pscratch/sd/t/tsfraser/sunbird/chains/voxel_voids/")
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--config_path", type=str, default="infer_nseries_cubic.yaml"
    )
    ...
    dir_store = f"hmc_nseries_cubic_ph{args.phase}_{statistics}_"\
